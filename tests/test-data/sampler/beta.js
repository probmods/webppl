...
module.exports = {
  ...
  settings: [
    ...
    {params: [2, 0.1], n: 5e05, skip: ['mode'], reltol: {mode: 0.2}},
    {params: [1, 0.2], n: 5e05, skip: ['mode'], reltol: {mode: 0.2}},
    {params: [2, 2], n: 1e05, skip: [], reltol: {mode: 0.2}},
    {params: [2, 4], n: 1e05, skip: [], reltol: {mode: 0.2}},
    {params: [3, 3], n: 1e05, skip: [], reltol: {mode: 0.2}},
