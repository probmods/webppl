...
module.exports = {
  ...
  getSourceMappedStacktrace: function(exception, compiledSourceMap, code) {
    console.log(exception.stack)
    var stacktrace = this.parse(exception);
    if (typeof compiledSourceMap === 'string') {
      compiledSourceMap = JSON.parse(compiledSourceMap);
    }
    var sourceMapConsumer = new SourceMap.SourceMapConsumer(compiledSourceMap);
