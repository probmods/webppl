...
module.exports = function(env) {
  ...
  var registerParams = require('./params/params')(env).register;
  ...
  function independent(targetDist, sampleAddress) {
    ...
    var guideParams = _.mapObject(distSpec.params, function(spec, name) {
      ...
      return _.has(spec, 'param') ?
             makeParam(spec.param, name, baseName) :
             spec.const;
  ...
  function makeParam(paramSpec, paramName, baseName) {
    ...
    var param = registerParam(name, viParamDim);
  ...
  function registerParam(name, dims) {
    return registerParams(name, function() {
