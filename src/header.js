...
module.exports = function(env) {
  ...
  var enumerate = require('./enumerate.js')(env);
  var particlefilter = require('./particlefilter.js')(env);
  ...
  env.sample = sample;
  env.factor = factor;
  env.sampleWithFactor = sampleWithFactor;
  env.exit = exit;
